...
Harian: Briefing (reuse pool berita, Web Speech) + Gempa BMKG + Harga (PAXG emas + pangan.go.id + BBM) + Kalender Hijriah (Aladhan) + libur (Nager.Date) + Bola 7 liga (ESPN + TheSportsDB 4790 Liga 1, UA fix, week Mon-Sun, timeline + logo). Detail: [`docs/PLAN_FITUR_HARIAN.md`](docs/PLAN_FITUR_HARIAN.md).
